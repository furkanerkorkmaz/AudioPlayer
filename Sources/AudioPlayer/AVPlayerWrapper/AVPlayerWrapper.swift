...
//  AudioPlayer
//
//  Created by Furkan Erkorkmaz on 06/03/2018.
...
class AVPlayerWrapper: AVPlayerWrapperProtocol {
    ...
    fileprivate var _state: AVPlayerWrapperState = .idle {
        didSet {
            if oldValue != _state {
...
//    static var HTTPHeaderFieldsKey = "AVURLAssetHTTPHeaderFieldsKey"
